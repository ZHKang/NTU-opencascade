...
if not ["%SCRIPTROOT%"] == [""] if exist "%SCRIPTROOT%\%SCRIPTROOT%" set "SCRIPTROOT=%SCRIPTROOT%\%SCRIPTROOT%"
if     ["%SCRIPTROOT%"] == [""] set "SCRIPTROOT=%SCRIPTROOT%"
...
set "CSF_SHMessage=%SCRIPTROOT%\src\SHMessage"
set "CSF_MDTVTexturesDirectory=%SCRIPTROOT%\src\Textures"
set "CSF_ShadersDirectory=%SCRIPTROOT%\src\Shaders"
set "CSF_XSMessage=%SCRIPTROOT%\src\XSMessage"
set "CSF_TObjMessage=%SCRIPTROOT%\src\TObj"
set "CSF_StandardDefaults=%SCRIPTROOT%\src\StdResource"
set "CSF_PluginDefaults=%SCRIPTROOT%\src\StdResource"
set "CSF_XCAFDefaults=%SCRIPTROOT%\src\StdResource"
set "CSF_TObjDefaults=%SCRIPTROOT%\src\StdResource"
set "CSF_StandardLiteDefaults=%SCRIPTROOT%\src\StdResource"

set "CSF_UnitsLexicon=%SCRIPTROOT%\src\UnitsAPI\Lexi_Expr.dat"
set "CSF_UnitsDefinition=%SCRIPTROOT%\src\UnitsAPI\Units.dat"
set "CSF_IGESDefaults=%SCRIPTROOT%\src\XSTEPResource"
set "CSF_STEPDefaults=%SCRIPTROOT%\src\XSTEPResource"
set "CSF_XmlOcafResource=%SCRIPTROOT%\src\XmlOcafResource"
set "CSF_MIGRATION_TYPES=%SCRIPTROOT%\src\StdResource\MigrationSheet.txt"

rem Draw Harness special stuff
if exist "%SCRIPTROOT%\src\DrawResources" (
  set "DRAWHOME=%SCRIPTROOT%\src\DrawResources"

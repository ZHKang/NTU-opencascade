...
#
# ActiveState ActiveTcl 8.6.0.0.296563 Win32/x86, Thu Jan 10 21:11:35 PST 2013
#
...
namespace eval ::activestate {
	...
	maturity      {final}
	arch          {win32-ix86}
	buildtime,sec {1357881095}
	buildtime,fmt {Thu Jan 10 21:11:35 PST 2013}
	as,mode       {normal}
    }
    ...
    variable  config
    array set config {
	{ActiveTcl} {ActiveState ActiveTcl 8.6.0.0.296563 Win32/x86 @ Thu Jan 10 21:11:35 PST 2013 / normal}
    }
}

package provide {ActiveTcl} {8.6.0.0.296563}
